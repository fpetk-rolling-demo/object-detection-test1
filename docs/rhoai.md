...
3) Access the `workbench` named `object-detection-test1-notebook`.
...
5) In the terminal, run `cd object-detection-test1` to navigate to your sample app's directory.
